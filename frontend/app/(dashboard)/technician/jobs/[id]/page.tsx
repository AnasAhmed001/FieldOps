...
import { ArrowLeft, Calendar, UserIcon, Send, FileText, Activity, Wrench } from "lucide-react";
    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-20">
      <div className="flex items-center gap-4">
        ...
        <div className="ml-auto flex gap-2">
           <UpdateStatusDialog jobId={id} currentStatus={job.status} userRole="technician">
